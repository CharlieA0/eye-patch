...
class raw:
    ...
    def _load_calib_cam_to_cam(self, velo_to_cam_file, cam_to_cam_file):
        ...
        # Load all calibration data by default
        data = dict(data, **filedata)

        # size matrix
        S_00 = tuple(filedata["S_00"].astype(int))
        S_01 = tuple(filedata["S_00"].astype(int))
        S_02 = tuple(filedata["S_00"].astype(int))
        S_03 = tuple(filedata["S_00"].astype(int))
        ...
        R_00 = np.reshape(filedata["R_00"], (3,3))
        R_01 = np.reshape(filedata["R_01"], (3,3))
        R_02 = np.reshape(filedata["R_02"], (3,3))
        R_03 = np.reshape(filedata["R_03"], (3,3))
        ...
        # 3x1 translation matrices
        T_00 = np.reshape(filedata["T_00"], (3,1))
        T_01 = np.reshape(filedata["T_01"], (3,1))
        T_02 = np.reshape(filedata["T_02"], (3,1))  
        T_03 = np.reshape(filedata["T_03"], (3,1))
        ...
        # 3x3 calibration matrices
        K_00 = np.reshape(filedata["K_00"], (3,3))
        K_01 = np.reshape(filedata["K_01"], (3,3))
        K_02 = np.reshape(filedata["K_02"], (3,3))
        K_03 = np.reshape(filedata["K_03"], (3,3))
        ...
        P_rect_01 = np.reshape(filedata['P_rect_01'], (3, 4))
        P_rect_02 = np.reshape(filedata['P_rect_02'], (3, 4))
        P_rect_03 = np.reshape(filedata['P_rect_03'], (3, 4))
        ...
        R_rect_01 = np.eye(4)
        R_rect_01[0:3, 0:3] = np.reshape(filedata['R_rect_01'], (3, 3))
        R_rect_02 = np.eye(4)
        R_rect_02[0:3, 0:3] = np.reshape(filedata['R_rect_02'], (3, 3))
        R_rect_03 = np.eye(4)
        R_rect_03[0:3, 0:3] = np.reshape(filedata['R_rect_03'], (3, 3))

        data['R_rect_00'] = R_rect_00
        data['R_rect_01'] = R_rect_01
        data['R_rect_02'] = R_rect_02
        data['R_rect_03'] = R_rect_03
        ...
        data['K_cam1'] = P_rect_01[0:3, 0:3]
        data['K_cam2'] = P_rect_02[0:3, 0:3]
        data['K_cam3'] = P_rect_03[0:3, 0:3]
